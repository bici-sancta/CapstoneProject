...
\end{figure}
\FloatBarrier
<Patrick's Section>: Random forest.

The regression model 

\FloatBarrier
\begin{figure}
 	\includegraphics[width=\textwidth, height=\textheight, keepaspectratio]{ResidualsPlot.png}
 	\caption{Map of Cincinnati with PSI regions identified by red color.}
	\label{figure:ResidualsPlot01t}

\end{figure}
\FloatBarrier

<Preeti's Section>: Unsupervised K-means and T-sne
%
\section{Analysis}
%
%
