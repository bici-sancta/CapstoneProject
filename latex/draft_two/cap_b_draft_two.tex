...
% ...	weird that it takes multiple cycles w/ human action ... whatever
%
...
\begin{table}
\begin{center}
\caption{ACM Code of Ethics}
\label{table:codeofethics}
\begin{tabular}{ p{.05\textwidth}  p{.70\textwidth}  p{.10\textwidth} p{.14\textwidth}}
\hline
\rule{0pt}{12pt}
	&	section	&	YnNA	&	Comment\\[2pt]
\hline
1,0
