...
For our unsupervised learning we lare very focused on the pedestrian safety issues. From the Figure ~\ref{figure:kmeansongrid} combining the results of our analysis and neighborhoods to make our observations: Cluster 0/ Blue areas College Hill, Clifton, Central business district, Over-the-Rhine have more people walking. The issues are Long wait for walk signal, Lack of Visibility, Lack of Crosswalk. These areas immediate need is to add more crosswalks, walk bridges to cut out of traffic. Cluster 1/ Yellow: West Wood, West Price hill, Pleasant Ridge, Kennedy Heights have issues like No Sidewalks, Jaywalking and Speeding. Speeding has been the biggest issue in these areas. This needs attention. Cluster 2/ Red: Sayler Park, East End, Mt. Washington, Winston Hill, Cartage main concerns are Walk signal is too short, Vehicles run red lights or stop signs, Vehicles do not yield at crosswalks. Walk signal too short might be the reason vehicles are getting too close to pedestrians. Perhaps longer signal is the much-needed change in this area.
